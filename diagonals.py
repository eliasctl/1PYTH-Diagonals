...
n = int(
  input("Entrez la taille du tableau dans lequel vous souhaitez jouer : "))
...
def displayScore(score):
  print("Scores : Le Joueur 1 à ", score[0], " points, le joueur 2 à ",
        score[1], " points .")
...
def win(score):
  if score[0] == score[1]:
    print("🎉Vous avez tous les deux gagner avec un total de ", score[0],
          " points !🎊")
...
# Test : cette modification à été effectuer depuis repplit
